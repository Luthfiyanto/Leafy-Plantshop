...
if (process.env.NODE_ENV !== "production") {
  ...
  console.info(`Loading environtment variables from ${envPath}`);
...
export const PUBLIC_URL = HEROKU_APP_NAME ? `https://${HEROKU_APP_NAME}.herokuapp.com` : /**@type {string} */ (process.env.PUBLIC_URL);
